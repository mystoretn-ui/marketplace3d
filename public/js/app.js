...
async function init(){try{const me=await api("/api/me");if(me.user){authLink.textContent="@"+me.user.username;authLink.href="/profile.html?username="+encodeURIComponent(me.user.username)} }catch{}load()}
